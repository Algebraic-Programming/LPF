...
/** 
 * \test Tests two lpf_gets where one memory location serves as source and destination for two gets in unsafe mode
 * \pre P >= 2
 * \return Exit code: 0
 */
TEST( func_bsplib_get_twice_on_same_remote_unsafemode )
{
