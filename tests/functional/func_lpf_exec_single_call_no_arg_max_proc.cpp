...
void spmd( lpf_t lpf, lpf_pid_t pid, lpf_pid_t nprocs, lpf_args_t args )
{
    ...
    EXPECT_LE( "%u", (lpf_pid_t) 1, nprocs );
    EXPECT_LE( "%u", (lpf_pid_t) 0, pid );
...
/** 
 * \test Test single lpf_exec() call without arguments on maximum number of processes
 * \pre P >= 1
 * \return Exit code: 0
 */
TEST( func_lpf_exec_single_call_no_arg_max_proc )
{
