...
/** 
 * \test Testing for a process that does a lpf_put on a slot after it has been deregistered
 * \pre P >= 1
 * \return Message: Invalid attempt to deregister a memory slot, because it is in use
 * \return Exit code: 6
 */
TEST( API, func_lpf_debug_put_after_deregister_dest_after_sync )
{
