...
/**
 * \test Testing for a process that does a lpf_put and a lpf_get while only
 * space for 1 request has been allocated \pre P >= 1 \return Message: This is
 * the 2-th message, while space for only 1 has been reserved \return Exit code:
 * 6
 */
