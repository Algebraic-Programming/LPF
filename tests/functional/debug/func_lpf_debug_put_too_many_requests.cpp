...
void spmd(lpf_t lpf, lpf_pid_t pid, lpf_pid_t nprocs, lpf_args_t args) {
  ...
  rc = lpf_put(lpf, xSlot, sizeof(int), (pid + 2) % nprocs, ySlot, sizeof(int),
...
/**
 * \test Testing for a process that sends more requests than allocated with
 * lpf_resize_message_queue() \pre P >= 1 \return Message: This is the 2-th
