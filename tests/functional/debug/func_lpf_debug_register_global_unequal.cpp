...
/** 
 * \test A program with a lpf_register_global that is not executed on all pids
 * \pre P >= 2
 * \return Message: Number of global registrations does not match.
 * \return Exit code: 6
 */
TEST( API, func_lpf_debug_register_global_unequal )
{
