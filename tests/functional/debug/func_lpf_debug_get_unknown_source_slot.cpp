...
void spmd( lpf_t lpf, lpf_pid_t pid, lpf_pid_t nprocs, lpf_args_t args )
{
    ...
    EXPECT_DEATH(lpf_get( lpf, (pid+1)%nprocs, ySlot, 0, xSlot, 0, sizeof(x), LPF_MSG_DEFAULT ), "LOL");
...
/** 
 * \test Testing a lpf_get with an unknown source memory slot
 * \pre P >= 1
 * \return Message: source memory slot does not exist
 * \return Exit code: 6
 */
TEST( API, func_lpf_debug_get_unknown_source_slot )
{
