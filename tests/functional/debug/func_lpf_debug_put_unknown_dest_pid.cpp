...
/**
 * \test Testing for a process that does a lpf_put() to another process that
 * does not exist \pre P >= 1 \pre P <= 5 \return Message: unknown process ID 6
 * for data destination \return Exit code: 6
 */
TEST(API, func_lpf_debug_put_unknown_dest_pid) {
