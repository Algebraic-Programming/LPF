...
/**
 * \test A program with a lpf_deregister of a global slot that is not executed
 * on all pids \pre P >= 2 \return Message: Number of deregistrations of global
 * slots does not match. \return Exit code: 6
 */
