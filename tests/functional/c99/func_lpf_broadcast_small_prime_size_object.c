...
/** 
 * \test Broadcasts an object whose size > P is not (easily) divisible by P but also small so that in the second phase of 2-phase broadcast have nothing to send.
 * \pre P >= 2
 * \return Exit code: 0
 */
TEST( func_lpf_broadcast_small_prime_size_object )
{
